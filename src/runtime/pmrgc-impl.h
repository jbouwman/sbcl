 ...
 * local heap's local collection, where they name that collection's
 * own lists (see local-heap-gc.inc).  Local collections on different
...
#ifndef LISP_FEATURE_SB_LOCAL_HEAPS
